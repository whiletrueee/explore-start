...
import { catV2, isMappedV2, mapsLink } from '@/lib/catalog';
  ...
  return (
    <div className="gd">
      <div className="gd-scroll">
        <div
          className="gd-hero"
          style={hasMedia ? { backgroundImage: `url(${item.media_url})` } : { background: `linear-gradient(150deg, ${c.color}, ${c.color}aa)` }}
        >
          {hasMedia ? null : <span className="gd-hero-glyph">{c.glyph}</span>}
          <button className="gd-back" onClick={onBack}>‹ All gems</button>
